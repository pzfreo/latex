...
\author{\IEEEauthorblockN{Paul Fremantle\IEEEauthorrefmark{1}\IEEEauthorrefmark{2},
Benjamin Aziz\IEEEauthorrefmark{1},
Jacek Kopeck\'{y}\IEEEauthorrefmark{1}, and
Philip Scott\IEEEauthorrefmark{1}\\}
\emph{\IEEEauthorblockA{\IEEEauthorrefmark{1}School of Computing, University of Portsmouth,Portsmouth, UK \\
\{paul.fremantle, benjamin.aziz, jacek.kopecky, philip.scott\}@port.ac.uk \\}
\IEEEauthorblockA{\IEEEauthorrefmark{2}WSO2 Inc., Mountain View, California \\
paul@wso2.com}
}}
...
%Jacek Kopeck\'{y}\IEEEauthorrefmark{1}, and 
%Philip Scott\IEEEauthorrefmark{1}}}
%\IEEEauthorblockA{\IEEEauthorrefmark{1}School of Computing,\\ University of Portsmouth,\\Portsmouth, UK }
%%paul.fremantle@port.ac.uk, \\ benjamin.aziz@port.ac.uk, \\ jacek.kopecky@port.ac.uk, \\ philip.scott@port.ac.uk }
%\IEEEauthorblockA{\IEEEauthorrefmark{2}WSO2 Inc., Mountain View, California }
%%paul@wso2.com}
